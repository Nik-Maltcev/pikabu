    ...
    <nav class="fixed top-0 w-full z-50 border-b border-slate-200 bg-white/80 backdrop-blur-md">
      <div class="flex justify-between items-center px-4 h-14 max-w-7xl mx-auto">
        <div class="flex items-center gap-4">
          <router-link to="/" class="text-lg font-bold tracking-tight text-slate-900 no-underline">BizMap</router-link>
          <div class="flex gap-3">
            <a class="text-cyan-600 border-b-2 border-cyan-600 pb-0.5 text-sm font-medium">Ниши</a>
            <router-link to="/account" class="text-slate-600 hover:text-slate-900 text-sm font-medium cursor-pointer">Отчеты</router-link>
            <router-link to="/#pricing" class="text-slate-600 hover:text-slate-900 text-sm font-medium cursor-pointer">Цены</router-link>
          </div>
        </div>
        <router-link to="/account" class="bg-black text-white text-sm font-medium px-3 py-1.5 rounded-lg hover:opacity-80 transition-opacity no-underline">Войти</router-link>
      </div>
    </nav>
